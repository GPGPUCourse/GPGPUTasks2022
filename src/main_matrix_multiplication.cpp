...
int main(int argc, char **argv)
{
...

    {
...

        {
            ...
            for (int iter = 0; iter < benchmarkingIters; ++iter) {
                ...
                unsigned int global_work_size_M = (M + work_group_size - 1) / work_group_size * work_group_size;
                unsigned int global_work_size_N = (N + work_group_size - 1) / work_group_size * work_group_size;
                matrix_multiplication_kernel.exec(
                        gpu::WorkSize(work_group_size, work_group_size, global_work_size_M, global_work_size_N), as_gpu,
                        bs_gpu, cs_gpu, M, K, N);
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            unsigned int global_work_size_N = (N/4 + work_group_size_N - 1) / work_group_size_N/4;
            matrix_multiplication_kernel.exec(
