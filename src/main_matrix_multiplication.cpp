...
int main(int argc, char **argv)
{
    ...
    ocl::Kernel matrix_multiplication_kernel(matrix_multiplication, matrix_multiplication_length, "matrix_multiplication1");
...

    {
        ...
        std::cout << "1 GPU: " << t.lapAvg() << "+-" << t.lapStd() << " s" << std::endl;
        std::cout << "1 GPU: " << gflops / t.lapAvg() << " GFlops" << std::endl;
    }
...

    {
        ...
        std::cout << "2 GPU: " << t.lapAvg() << "+-" << t.lapStd() << " s" << std::endl;
        std::cout << "2 GPU: " << gflops / t.lapAvg() << " GFlops" << std::endl;
    }
