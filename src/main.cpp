...
int main() {
    ...
    std::cout << "Device name: " << getArrayDeviceInfo<char>(device, CL_DEVICE_NAME).data() << "\n";
    ...
    cl_program program = clCreateProgramWithSource(context, 1, &source_string, nullptr, &err);
    OCL_SAFE_CALL(err);
